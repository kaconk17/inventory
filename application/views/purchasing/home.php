	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?php echo base_url(); ?>purchasing" class="active"><i class="lnr lnr-user"></i> <span>Supplier</span></a></li>
						
						<li><a href="<?php echo base_url(); ?>purchasing/items" class=""><i class="lnr lnr-dice"></i> <span>Items</span></a></li>
