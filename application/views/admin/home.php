		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="navbar-btn navbar-btn-right">
					...
					<a class="btn btn-success update-pro" href="auth/logout" title="Logout" target="_blank"><i class="fa fa-sign-out"></i></i> <span>LOGOUT</span></a>
				</div>
				<div id="navbar-menu">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
							<div class="row">
								<div >
									<button class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal-user"><i class="fa fa-plus"></i> Add New User</button>
		 ...
		 $('#table-user').DataTable({ 
					...
					columnDefs : [{
						...
						"render" : function (data, type, row) {
							var btn = "<center><a href=\"#\" class=\"btn btn-warning btn-xs\"><i class=\"fa fa-edit\"></i></a><a href=\"#\" class=\"btn btn-danger btn-xs\"><i class=\"fa fa-trash\"></i></a></center>";
							return btn;
						}
					}],
